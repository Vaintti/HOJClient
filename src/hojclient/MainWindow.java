    	...
    	public void run() {
    		while(true) {
    			try{
    				...
    				if(laitos.pullotusPumppuK‰ytˆss‰(0)) {
    				...
    				if(laitos.pullotusPumppuK‰ytˆss‰(1)) {
    				...
    				//K‰ytt‰j‰t
    				if(laitos.keittimenK‰ytt‰j‰(0)!= null){
    					String[] teksti = laitos.keittimenK‰ytt‰j‰(0);
    					proc1User.setText(teksti[0]);
    				}else{
    					proc1User.setText("User");
    				}
    				if(laitos.keittimenK‰ytt‰j‰(1)!= null){
    					String[] teksti = laitos.keittimenK‰ytt‰j‰(1);
    					proc1User.setText(teksti[0]);
    				}else{
    					proc1User.setText("User");
    				}
    				if(laitos.keittimenK‰ytt‰j‰(2)!= null){
    					String[] teksti = laitos.keittimenK‰ytt‰j‰(2);
    					proc1User.setText(teksti[0]);
    				}else{
    					proc1User.setText("User");
    				}
    				...
    				tank1Status.setText(Integer.toString(laitos.s‰iliˆnT‰yttˆaste(0)));
    				tank2Status.setText(Integer.toString(laitos.s‰iliˆnT‰yttˆaste(1)));
    				tank3Status.setText(Integer.toString(laitos.s‰iliˆnT‰yttˆaste(2)));
    				tank4Status.setText(Integer.toString(laitos.s‰iliˆnT‰yttˆaste(3)));
    				tank5Status.setText(Integer.toString(laitos.s‰iliˆnT‰yttˆaste(4)));
    				tank6Status.setText(Integer.toString(laitos.s‰iliˆnT‰yttˆaste(5)));
    				tank7Status.setText(Integer.toString(laitos.s‰iliˆnT‰yttˆaste(6)));
    				tank8Status.setText(Integer.toString(laitos.s‰iliˆnT‰yttˆaste(7)));
    				tank9Status.setText(Integer.toString(laitos.s‰iliˆnT‰yttˆaste(8)));
    				tank10Status.setText(Integer.toString(laitos.s‰iliˆnT‰yttˆaste(9)));
    			}catch(Exception e) {
